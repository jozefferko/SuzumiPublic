...
const AchievementPopUpContent = (props: {
    onClose: () => any;
                ...
                <SvgXml
                    xml={
                        props.achievement.claimed
                            ...
                            ? greyShieldSvg
                            : backgroundSvg[props.achievement.tier + 1]
                    }
                    height="100%"
                    width="100%"
                ...
                <View style={styles.iconContainer}>
                    <SvgXml
                        xml={
                            !props.achievement.unlocked
                                ? questionMark
                                : getIconSVG(props.achievement.id)
                        }
                        height="100%"
                        width="100%"
                        preserveAspectRatio="xMidYMid meet"
            ...
            {props.achievement.claimed ? (
                <Text style={styles.text}>
                    ...
                    <Text style={styles.highlighted}>
                        {props.achievement.reward} {t('points')}{' '}
                    </Text>
                    .
                </Text>
            ) : (
                <Text style={styles.text}>
                    ...
                    {t(' by completing this achievement')}
                </Text>
            )}
        </View>
    );
};
const AchievementPopUp = (props: props) => {
